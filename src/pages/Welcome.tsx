    ...
    <div ref={pageRef} className="overflow-x-hidden h-[400vh] relative">
      ...
      <div className="fixed top-0 left-0 w-full h-screen overflow-hidden">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('/uploads/93cf873b-02d6-4da8-99a9-09c557416601.png')`,
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('/uploads/9c4388d6-aa9f-488e-b113-e26968aa433b.png')`,
        ...
        <div 
          className="absolute w-full h-full"
          style={{ 
            backgroundImage: `url('/uploads/8927b987-ce53-4280-809a-69c112ef47a9.png')`,
            backgroundSize: "cover",
            backgroundPosition: "bottom",
            backgroundRepeat: "repeat-x",
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('/uploads/fdc3fb76-7813-40c7-8a71-d5625d22fbb7.png')`,
            backgroundSize: "cover",
            backgroundPosition: "bottom",
            backgroundRepeat: "repeat-x",
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary/20 to-transparent p-8 z-20 flex flex-col items-center">
            <div className="animate-bounce mb-4">
              <div className="relative">
                <img 
                  src="/uploads/04e8d05e-ecd0-4b2d-b616-f3261ce37016.png" 
                  alt="Raccoon mascot" 
